...
print("Plotting preprocessing info...")

"""
# Plot potentials
# Plot spiral variation at r = 7.0 and r = 7.5 like in the notebook for reference.
fi = np.linspace(0.01, 2*np.pi, 1000)
fig, ax = plt.subplots(1,2, layout='constrained')
ax[0].plot(fi, spiral_potential(7.0, fi))
ax[1].plot(fi, spiral_potential(7.5, fi))
ax[0].set_xlim(0,6.4)
ax[1].set_xlim(0,6.4)
...
ax[0][0].plot(ar, Omg_sp*np.ones(len(ar)))
ax[0][0].set_xlabel("r")
ax[0][0].set_ylabel("Ω")
ax[0][0].legend()
ax[0][0].grid(True)
