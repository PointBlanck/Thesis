...
def preprocess(r, phi, what="all"):
    ...
    if what == "all":
        ...
        ax[1][1].plot(r, ptnsm.omega(r), label="Ω")
        ax[1][1].plot(r, ptnsm.omega(r)+(ptnsm.epicyclic(r)/2), label="Ω + κ/2")
        ax[1][1].plot(r, ptnsm.omega(r)-(ptnsm.epicyclic(r)/2), label="Ω - κ/2")
        ax[1][1].plot(r, ptnsm.omega(r)-(ptnsm.epicyclic(r)/4), label="Ω - κ/4")
